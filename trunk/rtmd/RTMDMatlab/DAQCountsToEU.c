...
extern void DAQCountsToEU_Outputs_wrapper(const uint32_T *u0,
                          real_T *y0  , 
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const real_T  *gain  = mxGetData(PARAM_DEF0(S));
    const real_T  *Vslope  = mxGetData(PARAM_DEF1(S));
