% function [d]=incrtransformations(N,sample,AI,AO)
function [d]=incrtransformations(N,sample)
...
%next time step)
%Kinematics is based on the Incremental Transformation Method
sampletime=sample
N=24.9/sampletime
...
%     NIbatchForKinematics
    ...
    %%%% end of incremental beginning of total
