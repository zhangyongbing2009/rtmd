...
#define S_FUNCTION_NAME fixtofpwithscale
...
extern void fixtofpwithscale_Outputs_wrapper(const uint32_T *u0,
                          real_T *y0, 
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    fixtofpwithscale_Outputs_wrapper(u0, y0, scale, p_width0, S);
}
